export default function TaskCard({task, setComplete, setIncomplete, deleteTask}){
    if(task.status){
        return(
            <div className="card-container bg-blue-900 bg-opacity-0 w-9/12 h-22 rounded-lg border-b-4 border-blue-200 flex flex-row items-center justify-end m-2 pb-3">
            <div className="task-info grow">
                ...
                <button onClick={deleteTask} className="w-10 h-10 rounded-full bg-red-500 border-2 border-gray-800 text-white flex items-center justify-center hover:bg-blue-600 focus:outline-none mr-4">
                        x
                     </button>
